...
function createModel(_ref) {
    var Parent = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _vaneModel2.default;
    var name = _ref.name,
        _ref$data = _ref.data,
    ...
    var mobxSyncs = (0, _vaneModel.toMobxSyncActions)(syncs);
    var mobxAsyncs = (0, _vaneModel.toMobxAsyncActions)(effects);

    if (!(0, _vaneModel.isMobxModelClass)(Parent)) {
